                                    ...
                                    <div className="card-body p-4 p-lg-5 text-black bg-primary">
                                        <form>
                                            ...
                                            <div className="form-outline mb-4">
                                                <input type="email" id="email" placeholder="Digite su email" className="form-control form-control-lg" />
                                                <label className="form-label" for="email">Email</label>
                                            </div>
                                            <div className="form-outline mb-4">
                                                <input type="password" id="password" placeholder="Digite su contaseña" className="form-control form-control-lg" />
